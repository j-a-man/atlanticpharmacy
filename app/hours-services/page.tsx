        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card border border-border p-12 md:p-16 text-center space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Hours of Operation</h2>
            </div>
      ...
      <section className="py-24 px-6 lg:px-12 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Complete Convenience</h2>
          </div>
